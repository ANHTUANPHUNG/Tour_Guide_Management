...
public class InitGuide {
    public static void intGuide() {
        ...
        Guide guide1 = new Guide(1, "anhtuan", "123456", "Phùng Anh Tuấn", "25", "T.THuế", "0338943168", Arrays.asList("English", "Japanese"), EGender.male, "Available", Arrays.asList("enthusiastic", "humorous"), 4.5, Arrays.asList("#culinary", "#Mausoleum"),1500000);
        Guide guide2 = new Guide(2, "quangtuan", "123456", "Bùi Quang Tuấn", "27", "Đà Nẵng", "0703239292", Arrays.asList("Korean", "Chinese"), EGender.male, "Available", Arrays.asList("enthusiastic", "humorous"), 4.0, Arrays.asList("#Mausoleum", "#nature"),1200000);
        Guide guide3 = new Guide(3, "phamdat", "123456", "Phạm Văn Đạt", "22", "T.THuế", "0985700741", Arrays.asList("English", "Japanese"), EGender.male, "Available", Arrays.asList("enthusiastic", "humorous"), 3.9, Arrays.asList("#Mausoleum", "#culinary"),1000000);
        Guide guide4 = new Guide(4, "nguyethang", "123456", "Nguyễn Thắng", "24", "Quảng Ninh", "0867053286", Arrays.asList("Russian", "Japanese"), EGender.male, "Available", Arrays.asList("enthusiastic", "humorous"), 4.2, Arrays.asList("#culinary", "#Mausoleum"),1300000);
